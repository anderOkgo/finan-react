...
const translations = {
  en: {
    ...
    dailyAverageBudget: 'Daily Average Budget',
    dailyAverageBudgetNoToday: 'Daily Average (No Today)',
    movementInput: 'Movement Input',
    queue: 'Queue',
    selectCurrency: 'Select Currency',
    animecreamApp: 'Animecream',
    ...
    typeSummaryTable: 'Summary by Type',
    year: 'Year',
    hashtag: '#',
    month: 'Month',
    ...
    validationSelectOption: 'Please select an option.',
    validationTooShort: 'Please enter at least {min} characters.',
    validationTooLong: 'Please enter no more than {max} characters.',
    validationMinValue: 'Value must be at least {min}.',
    validationMaxValue: 'Value must be at most {max}.',
    validationBadNumber: 'Please enter a valid number.',
    validationInvalidEmail: 'Please enter a valid email address.',
    validationInvalidDate: 'Please enter a valid date and time.',
    validationInvalidValue: 'Please enter a valid value.',
    validationPatternMismatch: 'The value does not match the required format.',
  },
  es: {
    inputTab: 'Entrada',
    generalTab: 'General',
    ...
    dailyAverageBudget: 'Presupuesto Promedio Diario',
    dailyAverageBudgetNoToday: 'Promedio Diario (Sin Hoy)',
    ...
    typeSummaryTable: 'Resumen por Tipo',
    year: 'Año',
    hashtag: '#',
    month: 'Mes',
    ...
    'Unauthorized: Movement does not belong to this user':
      'No autorizado: El movimiento no pertenece a este usuario',
    ...
    validationSelectOption: 'Por favor, selecciona una opción.',
    validationTooShort: 'Introduce al menos {min} caracteres.',
    validationTooLong: 'Introduce como máximo {max} caracteres.',
    validationMinValue: 'El valor debe ser al menos {min}.',
    validationMaxValue: 'El valor debe ser como máximo {max}.',
    validationBadNumber: 'Introduce un número válido.',
    validationInvalidEmail: 'Introduce un correo electrónico válido.',
    validationInvalidDate: 'Introduce una fecha y hora válidas.',
    validationInvalidValue: 'Introduce un valor válido.',
    validationPatternMismatch: 'El valor no cumple el formato requerido.',
  },
};
