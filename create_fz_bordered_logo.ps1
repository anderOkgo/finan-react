...
$g.FillEllipse($linGrBrush, 40, 40, ($size - 80), ($size - 80))

# 2. Contrasting Border (White)
$pen = New-Object System.Drawing.Pen([System.Drawing.Color]::FromArgb(200, 255, 255, 255), 12)
$g.DrawEllipse($pen, 40, 40, ($size - 80), ($size - 80))

# 3. Subtle Shine
$path = New-Object System.Drawing.Drawing2D.GraphicsPath
$path.AddEllipse(40, 40, ($size - 80), ($size - 80))
...
$g.FillEllipse($pbg, 40, 40, ($size - 80), ($size - 80))

# 4. Monogram 'Fz'
$font = New-Object System.Drawing.Font("Segoe UI Semibold", 165, [System.Drawing.FontStyle]::Bold)
...
Resize-Icon 96 "icon-96x96"
Resize-Icon 32 "icon-32x32"
